...
const PRIVACY_URL = "https://voucarregar.com.br/politica-privacidade/";
    ...
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      >
        ...
        <Text style={styles.p}>
          ...
          em <Text style={styles.link} onPress={() => Linking.openURL(`mailto:${EMAIL}`)}>{EMAIL}</Text>.
        </Text>
        ...
        <Text style={styles.li}>• Conta e perfil: nome, e-mail, telefone/WhatsApp, CPF e, quando aplicável, dados de empresa.</Text>
        <Text style={styles.li}>• Documentos para habilitação de conta (quando exigidos): CNH, documento do veículo, comprovantes e fotos.</Text>
        <Text style={styles.li}>• Conteúdo e interações: mensagens, manifestações de interesse em fretes, avaliações/comentários (quando houver).</Text>

        <Text style={styles.h3}>3.2 Dados coletados automaticamente</Text>
        <Text style={styles.li}>• Dados técnicos do dispositivo: modelo, SO, idioma, fuso horário, IP e identificadores de dispositivo.</Text>
        ...
        <Text style={styles.note}>
          ...
          A busca por fretes é feita por cidades informadas manualmente. Caso, no futuro, a localização seja utilizada,
          pediremos permissão explícita e atualizaremos esta política.
        </Text>

        <Text style={styles.h3}>3.3 Cookies (site)</Text>
        <Text style={styles.p}>
          Utilizamos cookies essenciais e de medição no site para sessões, preferências e entendimento do uso.
        </Text>
        ...
        <Text style={styles.li}>• Biometria/Face ID: apenas para autenticação local. Não acessamos nem armazenamos sua biometria.</Text>
        ...
        <Text style={styles.li}>• Transportadoras/anunciantes: quando você interage com um frete, podemos compartilhar seus dados de contato do perfil para viabilizar o contato.</Text>
        <Text style={styles.li}>• Operadores/provedores: nuvem, notificações push, monitoramento/analytics e atendimento — sempre sob nossas instruções.</Text>
        ...
        <Text style={styles.p}>
          Adotamos medidas técnicas e organizacionais (TLS, controle de acesso, auditoria). Nenhum método é 100% infalível.
        </Text>

        <Text style={styles.h2}>9. Retenção</Text>
        <Text style={styles.li}>• Conta/Perfil: enquanto ativa e por prazo adicional para obrigações legais/defesa de direitos.</Text>
        ...
        <Text style={styles.p}>
          Você pode solicitar acesso, correção, anonimização/bloqueio/eliminação, portabilidade (quando aplicável),
          informações sobre compartilhamentos e revogação de consentimento. Contato:
        ...
        <Text style={styles.p}>Podem ocorrer quando usamos provedores no exterior, com garantias compatíveis à LGPD.</Text>
        ...
        <Text style={styles.p}>
          Podemos atualizar esta Política. A versão vigente estará no site e, quando relevante, avisaremos pelo App ou e-mail.
        </Text>

        <Text style={styles.h2}>15. Encarregado (DPO)</Text>
        <Text style={styles.p}>
          E-mail: <Text style={styles.link} onPress={() => Linking.openURL(`mailto:${EMAIL}`)}>{EMAIL}</Text> — Assunto “Privacidade – Vou Carregar”.
        </Text>
        ...
        >
          <Text style={styles.outLinkText}>Ver versão publicada no site</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  note: { fontSize: 13, color: "#374151", backgroundColor: "#F3F4F6", padding: 10, borderRadius: 8, marginTop: 8 },
  muted: { fontSize: 12, color: "#6b7280", marginTop: 4 },
  link: { color: "#2563eb", textDecorationLine: "underline" },
  card: { backgroundColor: "#F9FAFB", borderWidth: 1, borderColor: "#E5E7EB", padding: 12, borderRadius: 10, marginTop: 14 },
  outLinkBtn: { alignSelf: "center", paddingHorizontal: 14, paddingVertical: 10, borderRadius: 8, borderWidth: 1, borderColor: "#2563eb", marginTop: 16 },
  outLinkText: { color: "#2563eb", fontWeight: "700" },
});
